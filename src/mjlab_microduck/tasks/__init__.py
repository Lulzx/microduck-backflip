...
# Backflip — airborne backward revolution, feet-first landing.
register_mjlab_task(
...
_BACKLASH_TASKS = (
    ...
    ("Mjlab-Backflip-Flat-Backlash-MicroDuck", make_microduck_backflip_env_cfg, {}, MicroduckBackflipRlCfg, _BL_ALLCOL),
